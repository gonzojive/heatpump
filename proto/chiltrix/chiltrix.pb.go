...
type RegisterSnapshot struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	HoldingRegisterValues map[uint32]uint32      `protobuf:"bytes,1,rep,name=holding_register_values,json=holdingRegisterValues,proto3" json:"holding_register_values,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
const file_proto_chiltrix_chiltrix_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/chiltrix/chiltrix.proto\x12\bchiltrix\x1a\x1fgoogle/protobuf/timestamp.proto\"\x91\x01\n" +
	"\x05State\x12C\n" +
	"\x0fcollection_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x0ecollectionTime\x12C\n" +
	"\x0fregister_values\x18\x02 \x01(\v2\x1a.chiltrix.RegisterSnapshotR\x0eregisterValues\"\xcb\x01\n" +
	"\x10RegisterSnapshot\x12m\n" +
	"\x17holding_register_values\x18\x01 \x03(\v25.chiltrix.RegisterSnapshot.HoldingRegisterValuesEntryR\x15holdingRegisterValues\x1aH\n" +
	"\x1aHoldingRegisterValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\rR\x05value:\x028\x01\"\x11\n" +
	"\x0fGetStateRequest\"\x86\x01\n" +
	"\x12QueryStreamRequest\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"<\n" +
	"\x13QueryStreamResponse\x12%\n" +
	"\x05state\x18\x01 \x01(\v2\x0f.chiltrix.StateR\x05state\":\n" +
	"\rStateSequence\x12)\n" +
	"\x05diffs\x18\x01 \x03(\v2\x13.chiltrix.StateDiffR\x05diffs\"\xc0\x01\n" +
	"\tStateDiff\x12C\n" +
	"\x0fcollection_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x0ecollectionTime\x12A\n" +
	"\x0eupdated_values\x18\x02 \x01(\v2\x1a.chiltrix.RegisterSnapshotR\rupdatedValues\x12+\n" +
	"\x11deleted_registers\x18\x03 \x03(\rR\x10deletedRegisters\"\xb3\x01\n" +
	"\x13SetParameterRequest\x12\\\n" +
	"\x1ftarget_heating_mode_temperature\x18\x01 \x01(\v2\x15.chiltrix.TemperatureR\x1ctargetHeatingModeTemperature\x12>\n" +
	"\x0eregister_value\x18\x02 \x01(\v2\x17.chiltrix.RegisterValueR\rregisterValue\"A\n" +
	"\rRegisterValue\x12\x1a\n" +
	"\bregister\x18\x01 \x01(\rR\bregister\x12\x14\n" +
	"\x05value\x18\x02 \x01(\rR\x05value\"\x16\n" +
	"\x14SetParameterResponse\"6\n" +
	"\vTemperature\x12'\n" +
	"\x0fdegrees_celcius\x18\x01 \x01(\x01R\x0edegreesCelcius2[\n" +
	"\tHistorian\x12N\n" +
	"\vQueryStream\x12\x1c.chiltrix.QueryStreamRequest\x1a\x1d.chiltrix.QueryStreamResponse\"\x000\x012\x9d\x01\n" +
	"\x10ReadWriteService\x12O\n" +
	"\fSetParameter\x12\x1d.chiltrix.SetParameterRequest\x1a\x1e.chiltrix.SetParameterResponse\"\x00\x128\n" +
	"\bGetState\x12\x19.chiltrix.GetStateRequest\x1a\x0f.chiltrix.State\"\x00B.Z,github.com/gonzojive/heatpump/proto/chiltrixb\x06proto3"

var (
	file_proto_chiltrix_chiltrix_proto_rawDescOnce sync.Once
	file_proto_chiltrix_chiltrix_proto_rawDescData []byte
)

func file_proto_chiltrix_chiltrix_proto_rawDescGZIP() []byte {
	file_proto_chiltrix_chiltrix_proto_rawDescOnce.Do(func() {
		file_proto_chiltrix_chiltrix_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_chiltrix_chiltrix_proto_rawDesc), len(file_proto_chiltrix_chiltrix_proto_rawDesc)))
	})
...
func file_proto_chiltrix_chiltrix_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_chiltrix_chiltrix_proto_rawDesc), len(file_proto_chiltrix_chiltrix_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   2,
