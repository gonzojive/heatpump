...
def go_dependencies():
    """Load go repositories for the project."""
    ...
    go_repository(
        ...
        sum = "h1:sWtmgNxYM9P2sP+xEItMozsR3w0cqZFlqnNN1bdl41Y=",
        version = "v1.3.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3vxp+cjLqDe1TbogbwtMyeHRHr1tD+ksrK7xNppYRDs=",
        version = "v4.5.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_goburrow_modbus",
        importpath = "github.com/goburrow/modbus",
        sum = "h1:DejRZY73nEM6+bt5JSP6IsFolJ9dVcqxsYbpLbeW/ro=",
        version = "v0.1.0",
    )
    go_repository(
        name = "com_github_goburrow_serial",
        importpath = "github.com/goburrow/serial",
        sum = "h1:v2T1SQa/dlUqQiYIT8+Cu7YolfqAi3K96UmhwYyuSrA=",
        version = "v0.1.0",
    )
    ...
    go_repository(
        name = "com_github_howeyc_crc16",
        importpath = "github.com/howeyc/crc16",
        sum = "h1:IIVxLyDUYErC950b8kecjoqDet8P5S4lcVRUOM6rdkU=",
        version = "v0.0.0-20171223171357-2b2a61e366a6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:RrGCja4Grfz7QM2hw+SUZIYlbHoqBfbvzlWRT3seXB8=",
        version = "v0.0.0-20201103132853-d0aed0d254f8",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:I1gYcLUOYusV3BlPbpxRDk7T+k9YL6bDnew6wkSi1qA=",
        version = "v1.1.2",
    )
    ...
    go_repository(
        name = "com_github_martinlindhe_unit",
        importpath = "github.com/martinlindhe/unit",
        sum = "h1:7MhPWVVo8JsSdip23QdBy2A9Oe5dI6jLggWXVU05Qhg=",
        version = "v0.0.0-20201217003049-aef7d8d7910f",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_mtraver_iotcore",
        importpath = "github.com/mtraver/iotcore",
        sum = "h1:nJ5URXRbeJmu+IkIUpbqjRFa+m/zc3/uBUtzkf19FWo=",
        version = "v0.0.0-20210812222124-e6d0c936231c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:2aKucr+rQV6gHpY3bpeZu69uYoQOzVhGT3J22Op6Cjk=",
        version = "v1.33.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:dgauqwxO3VsDGJ96nbYlmSYim+e0aKQzGhKlr/NrTLY=",
        version = "v1.7.3",
    )
    go_repository(
